...
public interface PluginConstants {
    @NonNls final String RUN_TYPE = "xsltRunner";
    @NonNls final String RUNNER_DISPLAY_NAME = "XSL Transform Runner";
    final String RUNNER_DESCRIPTION = "XSL Transformation";
    ...
    final String PROPERTY_XSL_PATH = "argument.xsl_path";
