...
public class XsltRunner {
    final XsltRunnerConfiguration configuration;
    private volatile boolean stop = false;
    private final LogParser logParser;

    XsltRunner(XsltRunnerConfiguration configuration, LogParser logParser) {
    ...
    String getExecutable() {
        return configuration.pluginMsxslPath;
    }
...
//        args.add(configuration.extraOpts);
    ...
    /**
     * start the xslt runner
     */
    public void start() {
//
//        logMessage("[Starting XsltRunner]");
//
...
//        });
//        runnerThread.start();
        logMessage("[Xslt runner is started, but waiting until end to cat log file]");
